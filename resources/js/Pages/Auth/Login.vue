<template>
    <div class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-indigo-50 via-white to-purple-100 py-8 px-4">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 flex flex-col items-center animate-fade-in">
            ...
            <h2 class="text-2xl font-bold text-gray-900 mb-2 text-center">Entrar na sua conta</h2>
            <p class="text-gray-500 text-sm mb-6 text-center">Bem-vindo de volta! Por favor, faça login para continuar.</p>
            <form class="w-full space-y-4" @submit.prevent="submit">
                ...
                <div class="flex items-center justify-between w-full">
                    <label class="flex items-center text-sm text-gray-600 select-none">
                        <input
                            id="remember_me"
                            v-model="form.remember"
                            name="remember_me"
                            type="checkbox"
                            class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded mr-2 transition"
                        />
                        Lembrar de mim
                    </label>
                    <a href="#" class="text-sm text-indigo-600 hover:underline transition">Esqueceu sua senha?</a>
                </div>
                <button
                    type="submit"
                    :disabled="processing"
            ...
            <div class="mt-6 text-center">
                <a href="/register" class="text-indigo-600 hover:underline text-sm transition">Não tem uma conta? <span class="font-semibold">Registre-se</span></a>
            </div>
        </div>
    </div>
</template>
